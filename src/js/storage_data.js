import {regExpHTTPLinkFirst, cardsList, input} from '../js/constants.js';
...
export class StorageData {
  ...
  _preparePackageArray (resultsArray) {
    const _descriptionTextPreview = resultsArray.description; //.replace(regExpHTTPLinkFirst, ''); //временно отложил решение
